...
- **Geo-redundant storage (GRS)** for the Azure Files data share — attachments and Send files are replicated to the Azure paired region, providing disaster-recovery protection
