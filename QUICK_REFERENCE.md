...
- **Development**: `rg-vaultwarden-dev` / `vw-dev-app`
- **Staging**: `rg-vaultwarden-staging` / `vw-staging-app`
- **Production**: `rg-vaultwarden-prod` / `vw-prod-app`
...
```bash
# Vaultwarden aliases
alias vw-dev-logs="az containerapp logs show --name vw-dev-app --resource-group rg-vaultwarden-dev --follow"
alias vw-dev-status="az containerapp show --name vw-dev-app --resource-group rg-vaultwarden-dev --query '{state:properties.provisioningState, running:properties.runningStatus}'"
alias vw-prod-logs="az containerapp logs show --name vw-prod-app --resource-group rg-vaultwarden-prod --follow"
alias vw-prod-status="az containerapp show --name vw-prod-app --resource-group rg-vaultwarden-prod --query '{state:properties.provisioningState, running:properties.runningStatus}'"
```
